...
public class MemberController {
	...
	public void printMenu() throws Exception {
		...
		while (run) {
			if (mvo == null) {
				...
				String num = MainController.SC.nextLine();
				switch (num) {
				case "1":
					join();
					break;
	...
	private void join() throws Exception {
		...
		String inputId = MainController.SC.nextLine();
		System.out.println("Pwd : ");
		String inputPwd = MainController.SC.nextLine();
		System.out.println("BANK_ACCOUNT_NUMBER : ");
		String inputBAN = MainController.SC.nextLine();
	...
	public void deleteM() throws Exception {
		...
		String inputstr = MainController.SC.nextLine();
		if (inputstr.equals("1")) {
			System.out.println("삭제를 진행합니다.");
			System.out.println("비밀번호 입력 : ");
			String inputstr2 = MainController.SC.nextLine();

			if (inputstr2.equals(mvo.getPwd())) {
				Connection conn = Util.getConn();
	...
	public void mInfo() {
		...
		System.out.println(mvo.getBankAccountNumber());
	...
	public void mUpdateInfo() throws Exception {
		System.out.println("비밀번호 입력 : ");
		String inputstr1 = MainController.SC.nextLine();
		if (inputstr1.equals(mvo.getPwd())) {
			...
			if (inputstr2.equals("1")) {
				...
				String inputPwd1 = MainController.SC.nextLine();
				if(!inputPwd1.equals(mvo.getPwd())) {
					System.out.println("한번 더 입력해주세요.");
					String inputPwd2 = MainController.SC.nextLine();
				...
				} else if(inputPwd1.equals(mvo.getPwd())) {
